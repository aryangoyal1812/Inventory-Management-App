    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        authStateListener = new FirebaseAuth.AuthStateListener(){
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    //TODO : Check if the statements below need to be deleted or not
                    User u  = new User();
                    u.uid = user.getUid();
                    ...
                    //Toast.makeText(MainActivity.this,"Logged out user",Toast.LENGTH_SHORT).show();
                    //Log.d(TAG, "onAuthStateChanged:signed_in:" + user.getUid() + user.getEmail());
                }
            }
        };
...
//                startActivityForResult(intent,RC_SIGN_IN);
    ...
    private void handleSignInResult(@NonNull GoogleSignInResult result){
        Log.v(TAG,"The result is" + result.isSuccess());
        if(result.isSuccess() ){
            ...
            if(email.split("@")[1].equals("students.iitmandi.ac.in") || email.split("@")[1].equals(".iitmandi.ac.in")){

                Log.e(TAG, "Login successful. ");
                firebaseAuthWithGoogle(credential);
            }
            else{
                //TODO : Silently fail or alert the user
                Toast.makeText(MainActivity.this, "Use institute id", Toast.LENGTH_SHORT).show();
